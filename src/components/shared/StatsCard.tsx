...
const StatsCard: React.FC<StatsCardProps> = ({
  ...
  return (
    <div className="bg-[#111622] border border-[#1C2436] rounded-xl p-5 flex flex-col justify-between hover:border-[#1C2436]/80 transition-all duration-200 shadow-sm">
      {/* Top Row: Title & Icon */}
      <div className="flex items-center justify-between">
        <span className="text-[10px] font-bold uppercase tracking-wider text-[#64748B]">
          {title}
        </span>
        <div className="w-7 h-7 rounded-lg bg-[#1C2436]/60 flex items-center justify-center text-[#C6F135]">
