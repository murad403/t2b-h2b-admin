    ...
    return (
        <div className="space-y-4">
            ...
            {selectedIds.length > 0 && (
                <div className="bg-sidebar border border-card-border p-3.5 rounded-2xl flex flex-wrap items-center justify-between gap-4 animate-in fade-in duration-200">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            type="button"
                            className="px-3 py-1.5 rounded-xl bg-card border border-card-border text-title text-xs font-semibold hover:bg-card-border transition-colors cursor-pointer"
                        >
                            Export CSV
                        </button>
                        <button
                        ...
                        <button
                            type="button"
                            className="px-3 py-1.5 rounded-xl bg-primary text-bg-dark text-xs font-extrabold hover:brightness-110 transition-colors cursor-pointer"
                        >
                            Bulk Activate
                        </button>
                        <button
                            ...
                            className="px-3 py-1.5 rounded-xl text-description hover:text-title text-xs font-semibold transition-colors cursor-pointer"
                        >
                            Cancel
                        </button>
                    </div>
                            ...
                            <tr className="border-b border-card-border/80 text-[11px] font-extrabold uppercase tracking-wider text-description/80 bg-sidebar/50">
                                <th className="py-4 px-4 w-10 text-center">
                                    <input
                                        ...
                                        className="rounded border-card-border text-primary focus:ring-0 bg-sidebar cursor-pointer"
                                    />
                                </th>
                        ...
                        <tbody className="divide-y divide-card-border/60 text-xs">
                            {events.map((event) => {
                                ...
                                return (
                                    <tr
                                        key={event.id}
                                        className={`hover:bg-sidebar/30 transition-colors group ${isSelected ? "bg-sidebar/40" : ""
                                            }`}
                                    >
                                        {/* Checkbox */}
                                        ...
                                        <td className="py-4 px-6">
                                            <div className="flex items-center gap-3">
                                                ...
                                                />
                                                <div>
                                                    <p className="font-bold text-title text-xs sm:text-sm group-hover:text-primary transition-colors">
                                                        {event.name}
                                                    </p>
