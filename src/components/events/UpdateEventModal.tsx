...
import { updateEventSchema } from "@/validation/app.validation";
...
const UpdateEventModal: React.FC<UpdateEventModalProps> = ({ isOpen, event, onClose, onUpdate }) => {
    ...
    useEffect(() => {
        if (event && isOpen) {
            reset({
                ...
                clubHost: event.clubHost,
                region: event.region,
                regionalManager: event.regionalManager || "Bashar",
